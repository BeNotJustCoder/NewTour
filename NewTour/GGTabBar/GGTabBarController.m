...
- (void)viewDidLoad
{
    ...
    _tabBarView.backgroundColor = [UIColor colorWithRed:74.0/255 green:189.0/255 blue:204.0/255 alpha:1];
    //_tabBarView.backgroundColor = [UIColor colorWithRed:57.0 green:176.0 blue:194.0 alpha:1];
